        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Detail BBK</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="card p-3 shadow-sm">
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    ...
                    <input type="text" class="form-control" value="{{ $bbk->formc }} ({{ $bbk->mformcode->desc_c }})" disabled>
                </div>

                <div class="col-md-6 mt-3">
                    <label class="form-label">Warehouse</label>
                    <input type="text" class="form-control" value="{{ $bbk->warco }}" disabled>
                </div>
            ...
            <div class="row mt-4">
                ...
                <div class="accordion" id="accordionBbk">
                    @foreach ($bbk->bbkdtls as $i => $detail)
