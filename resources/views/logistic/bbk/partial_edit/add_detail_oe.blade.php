...
window.addOE = function(){
            ...
            <div class="accordion-body">
                <div class="row">
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="form-control select2 locco-editOE" name="locco[]" id="locco-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="select2 form-control opron-editOE" name="opron[]" id="opron-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control trqty-editOE" id="trqty-${i}" name="trqty[]" min="1" required
                            oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                            <span class="input-group-text unit-label-oe"></span>
                            <input type="text" class="stdqt-editOE" name="stdqt[]" id="stdqt-${i}" hidden>
                        </div>
                    </div>
    ...
    // ambil data barang
    $(document).on('change', '.locco-editOE', function() {
    ...
    // ambil detail barang
    $(document).on('change', '.opron-editOE', function() {
        const idx = this.id.split('-').pop();
    ...
    // VALIDASI INPUT QTY
    $(document).on('input', '.trqty-editOE', function() {
        const idx = this.id.split('-').pop();
...
<script>
    function setAccordionTitleOE(item){
