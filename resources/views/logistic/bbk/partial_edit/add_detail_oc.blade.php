...
window.addOC = function(){
            ...
            <div class="accordion-body">
                <div class="row">
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="form-control select2 locco-editOC" name="locco[]" id="locco-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="select2 form-control opron-editOC" name="opron[]" id="opron-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control trqty-editOC" id="trqty-${i}" name="trqty[]" min="1" required
                            oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                            <span class="input-group-text unit-label-oc"></span>
                            <input type="text" class="stdqt-editOC" name="stdqt[]" id="stdqt-${i}" hidden>
                        </div>
                    </div>
    ...
    // ambil data barang
    $(document).on('change', '.locco-editOC', function() {
    ...
    // ambil detail barang
    $(document).on('change', '.opron-editOC', function() {
        const idx = this.id.split('-').pop();
    ...
    // VALIDASI INPUT QTY
    $(document).on('input', '.trqty-editOC', function() {
        const idx = this.id.split('-').pop();
...
<script>
    function setAccordionTitleOC(item){
