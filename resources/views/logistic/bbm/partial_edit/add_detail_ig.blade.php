...
window.addIG = function(){
    ...
    const pono = "{{ $bbm->refno }}"; // untuk IG ini PO No
            ...
            <div class="accordion-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="select2 form-control opron-editIG" name="opron[]" id="opron-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control inqty-editIG" id="inqty-${i}" readonly style="background-color:#e9ecef;">
                            <span class="input-group-text unit-label-editIG"></span>
                            <input type="text" class="stdqt-editIG" name="stdqt[]" id="stdqt-${i}" hidden>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control trqty-editIG" id="trqty-${i}" name="trqty[]" min="1" required
                            oninput="
...
<script>
    function setAccordionTitleIG(item){
    ...
    $(document).on('change','select[name*="opron"]', function(){
        ...
        setAccordionTitleIG(item);
    });

    // panggil pas baru append ig
    setTimeout(() => {
        setAccordionTitleIG($('#accordion-item-'+i));
    },100);
</script>