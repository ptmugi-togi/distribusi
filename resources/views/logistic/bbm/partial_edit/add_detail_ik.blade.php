            ...
            <div class="accordion-body">
                <div class="row">
                    <div class="col-md-6 mt-3">
                        ...
                        <select class="select2 form-control opron-editIK" name="opron[]" id="opron-${i}" required>
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control trqty-editIK" id="trqty-${i}" name="trqty[]" min="1" required
                            oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                            <span class="input-group-text unit-label-editIK"></span>
                            <input type="text" class="stdqt-editIK" name="stdqt[]" id="stdqt-${i}" hidden>
                        </div>
                    </div>
...
<script>
    function setAccordionTitleIK(item){
    ...
    $(document).on('change','select[name*="opron"]', function(){
        ...
        setAccordionTitleIK(item);
    });

    // panggil pas baru append IK
    setTimeout(() => {
        setAccordionTitleIK($('#accordion-item-'+i));
    },100);
</script>