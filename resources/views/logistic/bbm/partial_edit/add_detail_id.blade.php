<script>
    ...
    // load detail barang based on OA
    $(document).on('change', '.opron-editID', function () {
        const $sel = $(this);
                ...
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <select class="select2 form-control opron-editID" name="opron[]" id="opron-${i}" required>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control trqty-editID" id="trqty-${i}" name="trqty[]" min="1" required
                                oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                <span class="input-group-text unit-label-editID"></span>
                            </div>
                        </div>
...
<script>
    function setAccordionTitleID(item){
