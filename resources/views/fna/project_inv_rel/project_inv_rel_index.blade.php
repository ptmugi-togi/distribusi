...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>List Project Invoice Release</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">List Project Invoice Release</li>
          </ol>
        </nav>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-lg-12" style="padding:0px 10px 10px 0px;">
                    <a id="tambahProjectInvRel" href="{{ route('project_inv_rel.create') }}" type="button" class="btn btn-success"> Release Project Invoice</a>
                </div>
                      ...
                      @foreach ($project_inv_rel as $p)
                        ...
                        <td class="text-center">
                          ...
                          @if (!$periodClosed && $p->braco == auth()->user()->cabang)
                            {{-- print --}}
                            @if ($p->resta != 'C')
                            <a href="{{ route('project_inv_rel.print', $p->invid) }}" class="badge bg-success" data-tooltip="true" data-bs-placement="top" title="Print"><i class="bi bi-file-earmark-arrow-down"></i></a>
                            @endif
                          @endif
                        </td>
                        </tr>
