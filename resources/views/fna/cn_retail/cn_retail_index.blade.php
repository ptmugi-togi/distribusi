...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>List Credit Note Retail</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">List Credit Note Retail</li>
          </ol>
        </nav>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-lg-12" style="padding:0px 10px 10px 0px;">
                    <a id="tambahCnRetail" href="{{ route('cn_retail.create') }}" type="button" class="btn btn-success"> Tambah CN Retail</a>
                </div>
