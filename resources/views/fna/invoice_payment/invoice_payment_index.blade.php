...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>List Invoice Payment</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">List Invoice Payment</li>
          </ol>
        </nav>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-lg-12" style="padding:0px 10px 10px 0px;">
                    <a id="tambahInvoicePayment" href="{{ route('invoice_payment.create') }}" type="button" class="btn btn-success"> Invoice Payment Create</a>
                </div>
                      ...
                      @foreach ($invoice_payment as $i)
                        ...
                        <td class="text-center">
                          ...
                          @if (!$periodClosed && $i->braco == auth()->user()->cabang)
                            <a href="/invoice-payment/detail/{{ $i->invpid }}" class="badge bg-primary" data-tooltip="true" data-bs-placement="top" title="Detail"><i class="bi bi-info-circle"></i></a>
                            <a href="/invoice-payment/edit/{{ $i->invpid }}" class="badge bg-warning" data-tooltip="true" data-bs-placement="top" title="Edit"><i class="bi bi-pencil"></i></a>
                            {{-- print --}}
                            @if ($i->resta != 'C')
