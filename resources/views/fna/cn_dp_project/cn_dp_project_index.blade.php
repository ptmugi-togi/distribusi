...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>List Credit Note DP / Project</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">List Credit Note DP / Project</li>
          </ol>
        </nav>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-lg-12" style="padding:0px 10px 10px 0px;">
                    <a id="tambahCnDpProject" href="{{ route('cn_dp_project.create') }}" type="button" class="btn btn-success"> Tambah CN DP/Project</a>
                </div>
