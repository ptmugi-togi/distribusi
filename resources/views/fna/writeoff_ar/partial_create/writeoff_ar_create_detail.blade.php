                ...
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="cust_{{ $i }}" class="form-control" readonly style="background-color: #E9ECEF">
                            <input type="hidden" name="cusno[]" id="cusno_{{ $i }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Currency</label>
                            <input type="text" name="curco[]" id="curco_{{ $i }}" class="form-control" readonly style="background-color: #E9ECEF">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Kurs</label>
                            <input type="text" id="irate_{{ $i }}" class="form-control price-input">
                            <input type="hidden" name="irate[]" id="irate_raw_{{ $i }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">DPP</label>
                            <input type="text" id="ntamt_{{ $i }}" class="form-control" readonly style="background-color: #E9ECEF">
                            <input type="hidden" name="ntamt[]" id="ntamt_raw_{{ $i }}">
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label">PPN</label>
                            <input type="text" id="txamt_{{ $i }}" class="form-control" readonly style="background-color: #E9ECEF">
                            <input type="hidden" name="txamt[]" id="txamt_raw_{{ $i }}">
                        </div>
...
function loadInvoice(el){
    ...
    $.get("{{ route('get-invoice-writeoff') }}", function(data){
...
$(document).on('change','.invoice-select',function(){
    ...
    let irate = selected.data('crate') || 1;
    ...
    $('#cust_' + index).val(selected.data('cust'));

    $('#ntamt_' + index).val(formatCurrency(selected.data('ntamt'), curco));
    $('#ntamt_raw_' + index).val(selected.data('ntamt'));

    $('#txamt_' + index).val(formatCurrency(selected.data('txamt'), curco));
    $('#txamt_raw_' + index).val(selected.data('txamt'));
    ...
    $('#curco_' + index).val(curco);
    $('#irate_raw_' + index).val(irate);
    $('#irate_' + index).val(formatRupiah(irate));
    toggleirateField(curco, irate);
});
        ...
        <div id="collapse${detailIndex}" class="accordion-collapse collapse show">
            <div class="accordion-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Customer</label>
                        <input type="text" id="cust_${detailIndex}" class="form-control" readonly style="background-color: #E9ECEF">
                        <input type="hidden" name="cusno[]" id="cusno_${detailIndex}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">Currency</label>
                        <input type="text" name="curco[]" id="curco_${detailIndex}" class="form-control" readonly style="background-color: #E9ECEF">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">Kurs</label>
                        <input type="text" id="irate_${detailIndex}" class="form-control price-input">
                        <input type="hidden" name="irate[]" id="irate_raw_${detailIndex}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">DPP</label>
                        <input type="text" id="ntamt_${detailIndex}" class="form-control" readonly style="background-color: #E9ECEF">
                        <input type="hidden" name="ntamt[]" id="ntamt_raw_${detailIndex}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label">PPN</label>
                        <input type="text" id="txamt_${detailIndex}" class="form-control" readonly style="background-color: #E9ECEF">
                        <input type="hidden" name="txamt[]" id="txamt_raw_${detailIndex}">
                    </div>
...
function validateRow(index){
    ...
    if((pcwo) > arval){
        ...
        Swal.fire({
            ...
            text:'Write Off tidak boleh melebihi A/R Value'
        });
