...
<main id="main" class="main">
    <div class="pagetitle">
        <h1>List MC Invoice Release</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">List MC Invoice Release</li>
          </ol>
        </nav>
    </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-lg-12" style="padding:0px 10px 10px 0px;">
                    <a id="tambahSir" href="{{ route('mc_invoice_release.create') }}" type="button" class="btn btn-success"> Tambah</a>
                </div>
