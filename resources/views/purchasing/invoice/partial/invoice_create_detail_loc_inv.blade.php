                ...
                <div class="accordion-body">
                    <div class="row">
                        <div class="col-md-6 mt-3">
                            ...
                            <select class="select2 form-control" name="pono[]" id="locinv-pono-{{ $barangIndex }}" required>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <select class="select2 form-control opron-select" name="opron[]" id="locinv-opron-{{ $barangIndex }}" required>
