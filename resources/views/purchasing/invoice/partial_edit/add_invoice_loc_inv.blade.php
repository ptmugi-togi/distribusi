<script>
    ...
    let invoiceIndex = document.querySelectorAll('#accordionInvoiceLocInv .accordion-item').length;
            ...
            <div id="barang-${currentIndex}" class="accordion-collapse collapse"
                ...
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-3">
                            <label for="poqty-${currentIndex}" class="form-label">Outstanding PO Quantity</label>
